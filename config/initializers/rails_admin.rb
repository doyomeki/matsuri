# RailsAdmin config file. Generated on May 15, 2013 08:35
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Content', 'ContentParticipation', 'Event', 'EventParticipation', 'Room', 'Schedule', 'Speaker', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Content', 'ContentParticipation', 'Event', 'EventParticipation', 'Room', 'Schedule', 'Speaker', 'User']
  ...
  # config.model 'ContentParticipation' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your content_participation.rb model definition
  ...
  #     configure :id, :integer 
  #     configure :content_id, :string 
  #     configure :event_participation_id, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  # config.model 'EventParticipation' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your event_participation.rb model definition
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your speaker.rb model definition
