  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved schedule as @schedule" do
        ...
        post :create, {:schedule => { "event_id" => "invalid value" }}, valid_session
        assigns(:schedule).should be_a_new(Schedule)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested schedule" do
        ...
        Schedule.any_instance.should_receive(:update_attributes).with({ "event_id" => "1" })
        put :update, {:id => schedule.to_param, :schedule => { "event_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the schedule as @schedule" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Schedule.any_instance.stub(:save).and_return(false)
        put :update, {:id => schedule.to_param, :schedule => { "event_id" => "invalid value" }}, valid_session
        assigns(:schedule).should eq(schedule)
      end
