  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved speaker as @speaker" do
        ...
        post :create, {:speaker => { "name" => "invalid value" }}, valid_session
        assigns(:speaker).should be_a_new(Speaker)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested speaker" do
        ...
        Speaker.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => speaker.to_param, :speaker => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the speaker as @speaker" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Speaker.any_instance.stub(:save).and_return(false)
        put :update, {:id => speaker.to_param, :speaker => { "name" => "invalid value" }}, valid_session
        assigns(:speaker).should eq(speaker)
      end
