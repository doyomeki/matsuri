  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved content as @content" do
        ...
        post :create, {:content => { "schedule_id" => "invalid value" }}, valid_session
        assigns(:content).should be_a_new(Content)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested content" do
        ...
        Content.any_instance.should_receive(:update_attributes).with({ "schedule_id" => "1" })
        put :update, {:id => content.to_param, :content => { "schedule_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the content as @content" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Content.any_instance.stub(:save).and_return(false)
        put :update, {:id => content.to_param, :content => { "schedule_id" => "invalid value" }}, valid_session
        assigns(:content).should eq(content)
      end
